            ...
            <div class="recent--patients">
                <div class="title">
                    ...
                    <div class="center">
                        ...
                        <label for="show" class="add"><i class="ri-add-line"></i>Thêm Admin</label>
                        <div class="container">
                            <label for="show" class="close-btn fas fa-times" title="close"></label>
                            <div class="text">
                                Thêm Admin
                            </div>
                            <form action="/include/Themadmin.php" method="POST" autocomplete="off">
                                <div class="data">
                                ...
                                <div class="btn">
                                    <div class="inner"></div>
                                    <input namne="themadmin" class="themnguoidung" type="submit" value="Thêm người dùng" />
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                if (isset($_POST["Tim"])) {
                    ...
                    if ($s == "") {
                        ...
                        $sql = "select * from admin where username Like '%$s%'";
                            ...
                            <table>
                                ...
                                ?> <tbody>
                                        <tr>
                                            ...
                                            <td><a onclick="return confirm('Bạn không có quyền chỉnh sửa người quản trị này');" href="#" <span><i style=' cursor: pointer;' class='ri-edit-line edit'></i></a>
                                                <a onclick="return confirm('Bạn không có quyền xóa người quản trị này');" href="#"> <i style=' cursor: pointer;' class='ri-delete-bin-line delete'></i></span></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                <?php
