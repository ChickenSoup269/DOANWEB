        ...
        <div class="box">
            <div class="inner-box">
                <div class="forms-wrap">
                    <form action="/include/HTdoiMK.php" method="POST" autocomplete="off" class="sign-in-form">
                        <div class="logo">
                        ...
                        <div class="actual-form">
                            ...
                            <div class="input-wrap">
                                <input name="Email" type="text" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Nhập địa chỉ Email" class="input-field" autocomplete="off" required />
                                <label>Email</label>
                            </div>

                            <div class="input-wrap">
                                <input name="pass_new" type="password" class="input-field" autocomplete="off" required />
                                <label>Mật khẩu mới</label>
                            </div>

                            <div class="input-wrap">
                                <input name="nhaplai_pass" type="password" minlength="1" class="input-field" autocomplete="off" required />
