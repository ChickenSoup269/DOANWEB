    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title">Thông tin tài khoản user</h2>
                    <div class="center">
                        <input type="checkbox" id="show">
                        <label for="show" class="add"><i class="ri-add-line"></i>Thêm User</label>
                        <div class="container">
                            <label for="show" class="close-btn fas fa-times" title="close"></label>
                            <div class="text">
                                Thêm người dùng
                            </div>
                            <form action="/include/Themnguoidung.php" method="POST" autocomplete="off">
                                <div class="data">
                                ...
                                <div class="data">
                                    <label>Email</label>
                                    <input name="Email" type="text" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Nhập địa chỉ Email" autocomplete="off" required />
                                </div>
                                <div class="data">
                                ...
                                <div class="btn">
                                    <div class="inner"></div>
                                    <input namne="themnguoidung" class="themnguoidung" type="submit" value="Thêm người dùng" />
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <table>
                                ...
                                ?> <tbody>
                                        <tr>
                                            ...
                                            <td><a href="/include/fix.php?ID=<?php echo $row['ID']; ?>" <span><i style=' cursor: pointer;' class='ri-edit-line edit'></i></a>
                                                <a onclick="return confirm('Bạn có muốn xóa user không');" href="/include/Xoanguoidung.php?ID=<?php echo $row['ID']; ?>"> <i style=' cursor: pointer;' class='ri-delete-bin-line delete'></i></span></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                <?php
